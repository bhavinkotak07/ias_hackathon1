...
def classify():
    ...
    image_data = request.files['file']
        #with open('images/user1.jpg', 'w') as f:
        #    pass
    file_name =  image_data.filename
    ext = image_data.filename.split('.')
    ext = ext[len(ext) - 1]
    #file_name = file_name + ext
    # extension = request.args['ext'] 
    # file_name = "image." + extension
    # img_data = urllib.unquote(img_data).decode('utf8') 
    image_data.save(os.path.join(app.config['UPLOAD_FOLDER'], file_name) )
